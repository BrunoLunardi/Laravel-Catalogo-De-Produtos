...
return [
    ...
    */
    ...
    //adicionado mensagem de erro customizada para titulo e referencia
    //OBS: está customização vale para todos os formulários que tiverem campos com os mesmos nomes inseridos aqui
    'custom' => [
        'attribute-name' => [
    ...
    */
    ...
    //campos do formulario resources/views/produtos/create.blade.php que serão validados
    //esta variavel substitui a mensagem de erro destes campos html pelos seus valores
